...
@section('content')
  <div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 text-gray-800">Data Surat Tugas</h1>
            ...
            <tr data-id="{{ $surat->id_surat_tugas }}">
              ...
              <td class="text-center">
                <div class="btn-group">
                  ...
                  <button class="btn btn-sm btn-info edit-btn" data-bs-toggle="modal" data-bs-target="#editModal" data-id="{{ $surat->id_surat_tugas }}">
            ...
            <div class="modal-body">
              <div class="row mb-3">
                ...
                <div class="col-md-6">
                  ...
                  <input type="date" class="form-control" id="tgl_penugasan" name="tgl_penugasan" required min="{{ date('Y-m-d') }}">
                </div>
              </div>
            </div>

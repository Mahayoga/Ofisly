<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="position: sticky !important; top: 0 !important; max-height: max-content !important">

    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
        <img src="{{ asset('assets/img/logo-ofisly-putih.png') }}"alt="Ofisly Logo"
        ...
        <li class="nav-item">
            ...
            <div id="collapseSurat" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item active" href="{{ route('surat-tugas-mandiri.index') }}">Surat Tugas
                        Mandiri</a>
                    <a class="collapse-item" href="{{ route('surat-tugas-promotor.index') }}">Surat Tugas Promotor</a>
                </div>
            </div>
        ...
        <li class="nav-item">
            ...
            <div id="collapseSurat" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('surat-tugas.index') }}">Surat Pengganti Driver</a>
                    <a class="collapse-item" href="{{ route('surat-tugas-mandiri.index') }}">Surat Tugas Mandiri</a>
                    <a class="collapse-item active" href="{{ route('surat-tugas-promotor.index') }}">Surat Tugas
                        Promotor</a>
                </div>
            </div>
        </li>
...
@if (Route::currentRouteName() == 'lowongan-pekerjaan.index')
    <li class="nav-item active">
        ...
        <div id="collapseLowongan" class="collapse show" aria-labelledby="headingPages"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded" style="max-height: 250px; overflow-y: auto;">
                <h6 class="collapse-header">Daftar Menu:</h6>
                <a class="collapse-item active" href="{{ route('lowongan-pekerjaan.index') }}">Data Lowongan</a>
                <a class="collapse-item" href="{{ route('pendaftar-lowongan.index') }}">Pendaftar Lowongan</a>
            </div>
        </div>
    </li>
@elseif(Route::currentRouteName() == 'pendaftar-lowongan.index')
    <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLowongan"
            aria-expanded="true" aria-controls="collapseLowongan">
            <i class="fas fa-fw fa-briefcase"></i>
        ...
        <div id="collapseLowongan" class="collapse show" aria-labelledby="headingPages"
            ...
            <div class="bg-white py-2 collapse-inner rounded" style="max-height: 250px; overflow-y: auto;">
                ...
                <a class="collapse-item active" href="{{ route('pendaftar-lowongan.index') }}">Pendaftar Lowongan</a>
            </div>
        </div>
    </li>
@else
    <li class="nav-item">
        ...
        <div id="collapseLowongan" class="collapse" aria-labelledby="headingPages"
            data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded" style="max-height: 250px; overflow-y: auto;">
                <h6 class="collapse-header">Daftar Menu:</h6>
                <a class="collapse-item" href="{{ route('lowongan-pekerjaan.index') }}">Data Lowongan</a>

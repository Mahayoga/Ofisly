...
@section('title', 'Arsip Surat Tugas Promotor')

@section('content')
<div class="container-fluid">
  <h1 class="h3 text-gray-800">Arsip Surat Tugas Promotor</h1>
  ...
  <div class="card border-0 mb-4">
    <div class="card-body border">
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover" id="arsipPromotorTable" width="100%" cellspacing="0">
...
@section('script')
  <script>
    ...
    $(document).ready(function() {
      table = new DataTable ('#arsipPromotorTable', {
        ajax: '{{ route('arsip-data-surat-tugas-promotor.fetchRowData') }}',
        columns: [
          {
            data: null,
          ...
          {data: 'penempatan'},
          {
            data: function(data, type, row) {
              return data.tgl_penugasan.split('T')[0];
            }
          },
          {
            data: function(data, type, row)  {
          ...
          },
          {
            ...
            render: function(data, type, row) {
              return `
                 <div class="btn-group">
                  <button class="btn btn-sm btn-info edit-btn" data-toggle="modal" data-target="#editModal" onclick="getDataEdit(this)" data-id="${row.id_surat_tugas_promotor}">
                    <i class="fas fa-trash-restore"></i>
                  </button>
                  <button class="btn btn-sm btn-danger delete-btn" data-toggle="modal" data-target="#deleteModal" onclick="getDataHapus(this)" data-id="${row.id_surat_tugas_promotor}">
    ...
    function editData(btn) {
      if(btn.getAttribute('data-id') == "null" || btn.getAttribute('data-id') == null) {
        ...
        let urlUpdate = '{{ route('arsip-data-surat-tugas-promotor.update', ['__ID__']) }}';
    ...
    function deleteData(btn) {
      if(btn.getAttribute('data-id') == "null" || btn.getAttribute('data-id') == null) {
        ...
        let urlDelete = '{{ route('arsip-data-surat-tugas-promotor.destroy', ['__ID__']) }}';

...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        for ($i = 1; $i <= 12; $i++){
            $suratTugasBulanan[$i] = SuratTugasPromotor::whereMonth('created_at', $i)->count() + SuratTugasMandiriModel::whereMonth('created_at', $i)->count() + SuratTugasPenggantiDriverModel::whereMonth('created_at', $i)
        }

...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        for ($i = 1; $i <= 12; $i++) {
            ...
            $md = (int) SuratTugasMandiriModel::whereYear('tgl_surat_pembuatan', $year)->whereMonth('tgl_surat_pembuatan', $i)->count();
            $pg = (int) SuratTugasPenggantiDriverModel::whereYear('tgl_surat_pembuatan', $year)->whereMonth('tgl_surat_pembuatan', $i)->count();

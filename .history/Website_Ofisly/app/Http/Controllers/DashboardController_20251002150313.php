...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        for ($i = 1; $i <= 12; $i++){
            $SuratPromotorBulanan = SuratTugasPromotor::whereMonth('created_at', $i)->count();
            $SuratMandiriBulanan = SuratTugasMandiriModel::whereMonth('created_at', $i)->count();
            $SuratPenggantiBulanan = SuratTugasPenggantiDriverModel::whereMonth('created_at', $i)->count();

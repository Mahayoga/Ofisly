...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        for ($i = 1; $i <= 12; $i++) {
            ...
            $suratTugasPromotorBulanan[$i] = $promotor;
            $suratTugasMandiriBulanan[$i]  = $mandiri;
            $suratTugasPenggantiBulanan[$i] = $pengganti;
            $suratTugasTotalBulanan[$i] = $promotor + $mandiri + $pengganti;
        }

...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card header py-3 d-flex justify-content-between align-items-center">
        ...
        <div>
            <span class="badge bg-primary text-white me-2"> Total Surat Tahun ini : {{ $totalSuratTahunan }}</span>
            <span class="badge bg-success text-white">Total Surat Bulan ini : {{ $totalSuratBulanan }}</span>
        </div>
    </div>
    <div class="card">
  ...
  <div style="height: 320px; width: 60%;">

    ...
    const suratPerBulanChart = new Chart(ctxBulanan, {
        ...
        data: {
            ...
            datasets: [
                ...
                {
                    labels: 'Surat Pengganti Driver',
                    data: @json(array_values($totalSuratPenggantiBulanan)),
                    borderColor: 'rgba(225, 206, 86, 1)',
                    backgroundColor: 'rgba(225, 206, )'

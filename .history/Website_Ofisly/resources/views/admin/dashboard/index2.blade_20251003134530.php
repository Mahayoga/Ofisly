...
<div class="container-fluid">
  ...
  <pre style="background-color: white; border-radius: 6px; padding: 10px;">
    promotor: @json($totalSuratPromotorBulanan),
    mandiri: @json($totalSuratMandiriBulanan),
    pengganti: @json($totalSuratPenggantiBulanan),
    total: @json($suratTugasBulanan)
  </pre>

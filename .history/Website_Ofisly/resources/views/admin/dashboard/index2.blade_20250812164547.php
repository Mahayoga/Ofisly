...
<div class="container-fluid">
  ...
  <div class="row mb-4">
      ...
      {{-- Card Lowongan --}}
      <div class="col-auto ps-1">
          <div class="card border-left-alert shadow-sm toggle-card" data-target="lowongan-content"
              style="width: 200px; height: 80px; cursor: pointer;">
              <div class="card-body p-2 d-flex align-items-center">
                  <i class="fas fa-briefcase text-alert fa-lg"></i>
                  <div style="margin-left: 13px">
                      <div class="font-weight-bold text-alert mb-0">Lowongan</div>
                      ...
                      <li class="list-group-item">
                          ...
                          <div class="mt-2 text-end">
                              <a href="{{ url('/surat-tugas/' . $s->id_surat_tugas) }}"
                                  class="btn btn-sm btn-alert">Detail</a>
                          </div>
                      </li>
                  @empty
...
<div id="lowongan-content" class="dashboard-content" style="display: none;">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-alert text-white">
...
<style>
    ...
    .border-alert { border-left-color: #f6c23e !important; }
</style>
@endsection

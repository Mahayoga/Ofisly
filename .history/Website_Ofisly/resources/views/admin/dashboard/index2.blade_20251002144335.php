    ...
    const suratPerBulanChart = new Chart(ctxBulanan, {
        ...
        data: {
            ...
            datasets: [
                {
                    labels: 'Total Surat',
                    data: @json(array_values($totalSuratPromotorBulanan)),
                ...
                {
                    labels: 'Total Surat Mandiri',
                    data: @json(array_values($totalSuratMandiriBulanan)),
                ...
                {
                    labels: 'Total Surat Pengganti Driver',
                    data: @json(array_values($totalSuratPenggantiDriverBulanan)),
                ...
                {
                    labels: 'Total Surat Pramubakti Mandiri',
                    data: @json(array_values($totalSuratPramubaktiMandiriBulanan)),

                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <ul class="list-gorup list-group-flush">
                            @forelse($daftarSuratTugas)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span>{{ $surat[] }}</span>
                                <span class="text-muted">{{ \Carbon\Carbon::parse($surat->tgl_surat_pembuatan)->format('d M Y') }}</span>
                            </li>
                            @empty
                            <li class="list-gorup-item text-center text-muted">Tidak ada surat Tugas Terbaru</li>
                            @endforelse
                        </ul>
                    </div>
                </div>

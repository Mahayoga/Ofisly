...
<div class="container-fluid">
  ...
  <div class="row mb-4">
      ...
      {{-- Card Lowongan --}}
      <div class="col-auto ps-1">
          <div class="card border-left-info shadow-sm toggle-card" data-target="lowongan-content"
              style="width: 200px; height: 80px; cursor: pointer;">
              <div class="card-body p-2 d-flex align-items-center">
                  <i class="fas fa-briefcase text-info fa-lg"></i>
                  <div style="margin-left: 13px">
                      <div class="font-weight-bold text-info mb-0">Lowongan</div>
...
<style>
    ...
    .border-info { border-left-color: #f6c23e !important; }
</style>
@endsection

...
<div class="container-fluid">
  ...
  <div class="row mb-4">
      ...
      {{-- Card Lowongan --}}
      <div class="col-auto ps-1">
          <div class="card border-left-warning shadow-sm toggle-card" data-target="user-content"
              style="width: 200px; height: 80px; cursor: pointer;">
              <div class="card-body p-2 d-flex align-items-center">
...
<script>
    document.querySelectorAll('.toggle-card').forEach(card => {
        card.addEventListener('click', function() {
            ...
            // Add appropriate border class based on target
            let borderClass = 'border-primary'; // default
            if (target === 'user-content') borderClass = 'border-success';
            else if (target === 'laporan-content') borderClass = 'border-warning';
            else if (target === 'other-content') borderClass = 'border-info';

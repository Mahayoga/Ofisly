    ...
    <div class="modal fade" id="editModal" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form id="editForm" action="{{ route('surat-tugas-mandiri.update', ['surat_penempatan_driver_mandiri' => '__ID__']) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="modal-body">
              <div class="row mb-3">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form id="deleteForm" action="{{ route('surat-tugas-mandiri.destroy', ['surat_penempatan_driver_mandiri' => '__ID__']) }}" method="POST">
            @csrf
            @method('DELETE')
            <div class="modal-body">
...
@section('script')
  ...
  <script>
    ...
    function getDataEdit(element) {
      ...
      let urlEdit = '{{ route('surat-tugas-mandiri.edit', ['surat_penempatan_driver_mandiri' => '__ID__']) }}';
      let urlUpdate = '{{ route('surat-tugas-mandiri.update', ['surat_penempatan_driver_mandiri' => '__ID__']) }}';
    ...
    function getDataHapus(element) {
      let idEdit = element.getAttribute('data-id');
      let urlEdit = '{{ route('surat-tugas-mandiri.edit', ['surat_penempatan_driver_mandiri' => '__ID__']) }}';
      let urlDelete = '{{ route('surat-tugas-mandiri.destroy', ['surat_penempatan_driver_mandiri' => '__ID__']) }}';
      $.get(urlEdit.replace('__ID__', idEdit), function(data) {
